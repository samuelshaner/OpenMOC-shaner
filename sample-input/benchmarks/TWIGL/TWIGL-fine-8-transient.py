...
materials = materialize.materialize('TWIGL-materials-ramp.py')
...
tcmfd.setVelocity([1e7, 2e5])

transientSolver = TransientSolver(geometry, tcmfd, cmfd)
transientSolver.setKappa(2.43)
...
transientSolver.setPowerInit(1.0)

transientSolver.solveInitialState()

for t in range(int(0.5/dt_moc)):
