...
class Solver(_object):
    ...
    def isUsingSinglePrecision(self): return _openmoc_cuda.Solver_isUsingSinglePrecision(self)
    ...
    def isUsingExponentialIntrinsic(self): return _openmoc_cuda.Solver_isUsingExponentialIntrinsic(self)
    ...
    def initializeCmfd(self): return _openmoc_cuda.Solver_initializeCmfd(self)
...
class CLSolver(Solver):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _openmoc_cuda.delete_CLSolver
    __del__ = lambda self : None;
    def getFSRScalarFlux(self, *args, **kwargs): return _openmoc_cuda.CLSolver_getFSRScalarFlux(self, *args, **kwargs)
    def getFSRScalarFluxes(self): return _openmoc_cuda.CLSolver_getFSRScalarFluxes(self)
    def setNumThreadBlocks(self, *args, **kwargs): return _openmoc_cuda.CLSolver_setNumThreadBlocks(self, *args, **kwargs)
    def setNumThreadsPerBlock(self, *args, **kwargs): return _openmoc_cuda.CLSolver_setNumThreadsPerBlock(self, *args, **kwargs)
    def setGeometry(self, *args, **kwargs): return _openmoc_cuda.CLSolver_setGeometry(self, *args, **kwargs)
    def setTrackGenerator(self, *args, **kwargs): return _openmoc_cuda.CLSolver_setTrackGenerator(self, *args, **kwargs)
    def computeScalarTrackIndex(self, *args, **kwargs): return _openmoc_cuda.CLSolver_computeScalarTrackIndex(self, *args, **kwargs)
    def computeFSRFissionRates(self, *args, **kwargs): return _openmoc_cuda.CLSolver_computeFSRFissionRates(self, *args, **kwargs)
CLSolver_swigregister = _openmoc_cuda.CLSolver_swigregister
...
def clCloneMaterial(*args, **kwargs):
  return _openmoc_cuda.clCloneMaterial(*args, **kwargs)
clCloneMaterial = _openmoc_cuda.clCloneMaterial

def clCloneTrackOnGPU(*args, **kwargs):
  return _openmoc_cuda.clCloneTrackOnGPU(*args, **kwargs)
clCloneTrackOnGPU = _openmoc_cuda.clCloneTrackOnGPU
